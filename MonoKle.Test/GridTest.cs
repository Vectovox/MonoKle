namespace MonoKle
{
    ...
    public class GridTest
    {
        ...
        [TestMethod]
        public void CellsFromLine_CorrectHorizontal()
        {
            CollectionAssert.AreEqual(new MPoint2[]{
                new MPoint2(0,1),
                new MPoint2(1,1),
                new MPoint2(2,1)
        ...
        [TestMethod]
        public void CellsFromLine_CorrectVertical()
        {
            CollectionAssert.AreEqual(new MPoint2[]{
                new MPoint2(1,0),
                new MPoint2(1,1),
        ...
        [TestMethod]
        public void CellsFromLine_CorrectDiagonalAbove()
        {
            CollectionAssert.AreEqual(new MPoint2[]{
                new MPoint2(1,0),
                new MPoint2(1,1),
        ...
        [TestMethod]
        public void CellsFromLine_CorrectDiagonalBelow()
        {
            CollectionAssert.AreEqual(new MPoint2[]{
                new MPoint2(0,1),
                new MPoint2(0,2),
        ...
        [TestMethod]
        public void CellsFromLine_CorrectDiagonalMiddle()
        {
            CollectionAssert.AreEqual(new MPoint2[]{
                new MPoint2(0,0),
                new MPoint2(0,1),
