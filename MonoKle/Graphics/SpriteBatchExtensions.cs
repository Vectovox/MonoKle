...
namespace MonoKle.Graphics
{
    public static class SpriteBatchExtensions
    {
        public static void Draw(this SpriteBatch spriteBatch, MTexture texture, Vector2 position, Color color,
            ...
            spriteBatch.Draw(texture.TextureData, position, texture.AtlasRectangle, color, rotation, origin, scale, effects, layerDepth);
        ...
        public static void Draw(this SpriteBatch spriteBatch, MTexture texture, Rectangle destinationRectangle,
            ...
            spriteBatch.Draw(texture.TextureData, destinationRectangle, texture.AtlasRectangle, color, rotation, origin, effects, layerDepth);

        public static void Draw(this SpriteBatch spriteBatch, MTexture texture, Vector2 position, Color color) =>
            spriteBatch.Draw(texture.TextureData, position, texture.AtlasRectangle, color);

        public static void Draw(this SpriteBatch spriteBatch, MTexture texture, Rectangle destinationRectangle, Color color) =>
            spriteBatch.Draw(texture.TextureData, destinationRectangle, texture.AtlasRectangle, color);
    }
}
